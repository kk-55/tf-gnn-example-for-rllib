...
from tfgnn_rllib.examples.env.graph_obs_env import GraphObsEnv
from tfgnn_rllib.examples.models.graph_obs_model import TFGraphObsModel
    ...
    graph_schema = tfgnn.parse_schema(
        ...
        context {
            features {
                key: "global_context"
                value {
                    description: "(Global) context features for the whole graph"
                    dtype: DT_FLOAT
                    shape { dim { size: 20 } }
                }
            }
